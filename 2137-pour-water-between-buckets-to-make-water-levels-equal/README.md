...
<pre style="position: relative;"><strong>Input:</strong> buckets = [1,2,7], loss = 80
...
<pre style="position: relative;"><strong>Input:</strong> buckets = [2,4,6], loss = 50
...
<pre style="position: relative;"><strong>Input:</strong> buckets = [3,3,3,3], loss = 40
