...
<pre style="position: relative;"><strong>Input:</strong> start = "_L__R__R_", target = "L______RR"
...
<pre style="position: relative;"><strong>Input:</strong> start = "R_L_", target = "__LR"
...
<pre style="position: relative;"><strong>Input:</strong> start = "_R", target = "R_"
<strong>Output:</strong> false
<strong>Explanation:</strong> The piece in the string start can move only to the right, so it is impossible to obtain the string target from start.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
