...
<pre style="position: relative;"><strong>Input:</strong> colors = [1,1,2,1,3,2,2,3,3], queries = [[1,3],[2,2],[6,1]]
...
<pre style="position: relative;"><strong>Input:</strong> colors = [1,2], queries = [[0,3]]
