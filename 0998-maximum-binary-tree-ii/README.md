...
<pre style="position: relative;"><strong>Input:</strong> root = [4,1,3,null,null,2], val = 5
...
<pre style="position: relative;"><strong>Input:</strong> root = [5,2,4,null,1], val = 3
...
<pre style="position: relative;"><strong>Input:</strong> root = [5,2,3,null,1], val = 4
