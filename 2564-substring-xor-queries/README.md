...
<pre style="position: relative;"><strong>Input:</strong> s = "101101", queries = [[0,5],[1,2]]
...
<pre style="position: relative;"><strong>Input:</strong> s = "0101", queries = [[12,8]]
...
<pre style="position: relative;"><strong>Input:</strong> s = "1", queries = [[4,5]]
