...
<pre style="position: relative;"><strong>Input:</strong> rungs = [1,3,5,10], dist = 2
...
<pre style="position: relative;"><strong>Input:</strong> rungs = [3,6,8,10], dist = 3
...
<pre style="position: relative;"><strong>Input:</strong> rungs = [3,4,6,7], dist = 2
