...
<pre style="position: relative;"><strong>Input:</strong> chalk = [5,1,5], k = 22
...
Student number 0 does not have enough chalk, so they will have to replace it.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 2:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> chalk = [3,4,1,2], k = 25
