...
<pre style="position: relative;"><strong>Input:</strong> num = "5023"
...
<pre style="position: relative;"><strong>Input:</strong> num = "25??"
...
<pre style="position: relative;"><strong>Input:</strong> num = "?3295???"
<strong>Output:</strong> false
