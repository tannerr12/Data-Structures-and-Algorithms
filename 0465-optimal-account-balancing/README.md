...
<pre style="position: relative;"><strong>Input:</strong> transactions = [[0,1,10],[2,0,5]]
...
<pre style="position: relative;"><strong>Input:</strong> transactions = [[0,1,10],[1,0,1],[1,2,5],[2,0,5]]
