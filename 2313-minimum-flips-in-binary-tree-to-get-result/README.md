<h2><a href="https://leetcode.com/problems/minimum-flips-in-binary-tree-to-get-result/">2313. Minimum Flips in Binary Tree to Get Result</a></h2><h3>Hard</h3><hr><div><p>You are given the <code>root</code> of a <strong>binary tree</strong> with the following properties:</p>
...
<pre style="position: relative;"><strong>Input:</strong> root = [3,5,4,2,null,1,1,1,0], result = true
...
<pre style="position: relative;"><strong>Input:</strong> root = [0], result = false
