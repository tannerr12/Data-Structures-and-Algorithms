...
<pre style="position: relative;"><strong>Input:</strong> text = "ababa"
...
<pre style="position: relative;"><strong>Input:</strong> text = "aaabaaa"
...
<pre style="position: relative;"><strong>Input:</strong> text = "aaaaa"
