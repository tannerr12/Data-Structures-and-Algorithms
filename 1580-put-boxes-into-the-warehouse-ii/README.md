...
<pre style="position: relative;"><strong>Input:</strong> boxes = [1,2,2,3,4], warehouse = [3,4,1,2]
...
<pre style="position: relative;"><strong>Input:</strong> boxes = [3,5,5,2], warehouse = [2,1,3,4,5]
