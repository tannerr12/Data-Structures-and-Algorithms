...
<pre style="position: relative;"><strong>Input:</strong> nums = [1,1,1,3,9,9,9,2,10,10]
...
So the answer would be 5.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
