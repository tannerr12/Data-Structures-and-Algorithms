...
<pre style="position: relative;"><strong>Input:</strong> rains = [1,2,3,4]
...
<pre style="position: relative;"><strong>Input:</strong> rains = [1,2,0,0,2,1]
...
<pre style="position: relative;"><strong>Input:</strong> rains = [1,2,0,1,2]
