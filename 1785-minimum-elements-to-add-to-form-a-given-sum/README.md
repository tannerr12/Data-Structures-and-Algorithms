...
<pre style="position: relative;"><strong>Input:</strong> nums = [1,-1,1], limit = 3, goal = -4
...
<pre style="position: relative;"><strong>Input:</strong> nums = [1,-10,9,1], limit = 100, goal = 0
