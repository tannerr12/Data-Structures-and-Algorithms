...
<pre style="position: relative;"><strong>Input:</strong> nums1 = [1,7,5], nums2 = [2,3,5]
...
<pre style="position: relative;"><strong>Input:</strong> nums1 = [2,4,6,8,10], nums2 = [2,4,6,8,10]
...
<pre style="position: relative;"><strong>Input:</strong> nums1 = [1,10,4,4,2,7], nums2 = [9,3,5,1,7,4]
