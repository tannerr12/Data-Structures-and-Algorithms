<h2><a href="https://leetcode.com/problems/change-minimum-characters-to-satisfy-one-of-three-conditions/">1737. Change Minimum Characters to Satisfy One of Three Conditions</a></h2><h3>Medium</h3><hr><div><p>You are given two strings <code>a</code> and <code>b</code> that consist of lowercase letters. In one operation, you can change any character in <code>a</code> or <code>b</code> to <strong>any lowercase letter</strong>.</p>
...
<pre style="position: relative;"><strong>Input:</strong> a = "aba", b = "caa"
...
<pre style="position: relative;"><strong>Input:</strong> a = "dabadd", b = "cda"
