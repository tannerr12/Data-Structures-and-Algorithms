...
<pre style="position: relative;"><strong>Input:</strong> arr = [6,4,14,6,8,13,9,7,10,6,12], d = 2
...
<pre style="position: relative;"><strong>Input:</strong> arr = [3,3,3,3,3], d = 3
...
<pre style="position: relative;"><strong>Input:</strong> arr = [7,6,5,4,3,2,1], d = 1
