...
<pre style="position: relative;"><strong>Input:</strong> source = [1,2,3,4], target = [2,1,4,5], allowedSwaps = [[0,1],[2,3]]
...
<pre style="position: relative;"><strong>Input:</strong> source = [1,2,3,4], target = [1,3,2,4], allowedSwaps = []
...
<pre style="position: relative;"><strong>Input:</strong> source = [5,1,2,4,3], target = [1,5,4,2,3], allowedSwaps = [[0,4],[4,2],[1,3],[1,4]]
