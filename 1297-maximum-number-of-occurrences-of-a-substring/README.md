...
<pre style="position: relative;"><strong>Input:</strong> s = "aababcaab", maxLetters = 2, minSize = 3, maxSize = 4
...
<pre style="position: relative;"><strong>Input:</strong> s = "aaaa", maxLetters = 1, minSize = 3, maxSize = 3
<strong>Output:</strong> 2
