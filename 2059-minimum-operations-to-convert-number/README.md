...
<pre style="position: relative;"><strong>Input:</strong> nums = [2,4,12], start = 2, goal = 12
...
<pre style="position: relative;"><strong>Input:</strong> nums = [3,5,7], start = 0, goal = -4
<strong>Output:</strong> 2
...
<pre style="position: relative;"><strong>Input:</strong> nums = [2,8,16], start = 0, goal = 1
