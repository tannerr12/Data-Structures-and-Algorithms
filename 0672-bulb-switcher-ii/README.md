...
<pre style="position: relative;"><strong>Input:</strong> n = 1, presses = 1
...
<pre style="position: relative;"><strong>Input:</strong> n = 2, presses = 1
...
<pre style="position: relative;"><strong>Input:</strong> n = 3, presses = 1
