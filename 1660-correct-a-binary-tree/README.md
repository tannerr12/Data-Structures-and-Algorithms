...
<pre style="position: relative;"><strong>Input:</strong> root = [1,2,3], fromNode = 2, toNode = 3
...
<pre style="position: relative;"><strong>Input:</strong> root = [8,3,1,7,null,9,4,2,null,null,null,5,6], fromNode = 7, toNode = 4
