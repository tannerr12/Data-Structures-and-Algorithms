...
<pre style="position: relative;"><strong>Input:</strong> firstString = "abcd", secondString = "bccda"
...
<pre style="position: relative;"><strong>Input:</strong> firstString = "ab", secondString = "cd"
