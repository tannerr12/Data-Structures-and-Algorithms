...
<pre style="position: relative;"><strong>Input:</strong> head = [3,1]
...
<pre style="position: relative;"><strong>Input:</strong> head = [5,3,1,2,5,1,2]
...
<pre style="position: relative;"><strong>Input:</strong> head = [1,3,2,2,3,2,2,2,7]
