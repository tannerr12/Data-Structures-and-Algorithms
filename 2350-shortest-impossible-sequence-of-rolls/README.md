...
<pre style="position: relative;"><strong>Input:</strong> rolls = [4,2,1,2,3,3,2,4,1], k = 4
...
Note that there are other sequences that cannot be taken from rolls.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 2:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> rolls = [1,1,2,2], k = 2
...
<pre style="position: relative;"><strong>Input:</strong> rolls = [1,1,3,2,2,2,3,3], k = 4
