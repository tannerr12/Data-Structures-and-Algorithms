...
<pre style="position: relative;"><strong>Input:</strong> ages = [16,16]
...
<pre style="position: relative;"><strong>Input:</strong> ages = [16,17,18]
<strong>Output:</strong> 2
...
<pre style="position: relative;"><strong>Input:</strong> ages = [20,30,100,110,120]
