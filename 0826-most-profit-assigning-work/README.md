...
<pre style="position: relative;"><strong>Input:</strong> difficulty = [2,4,6,8,10], profit = [10,20,30,40,50], worker = [4,5,6,7]
...
<pre style="position: relative;"><strong>Input:</strong> difficulty = [85,47,57], profit = [24,66,99], worker = [40,25,25]
