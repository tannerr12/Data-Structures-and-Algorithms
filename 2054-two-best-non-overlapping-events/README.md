...
<pre style="position: relative;"><strong>Input:</strong> events = [[1,3,2],[4,5,2],[2,4,3]]
...
<pre style="position: relative;"><strong>Input:</strong> events = [[1,3,2],[4,5,2],[1,5,5]]
...
<pre style="position: relative;"><strong>Input:</strong> events = [[1,5,3],[1,5,1],[6,6,5]]
<strong>Output:</strong> 8
<strong>Explanation: </strong>Choose events 0 and 2 for a sum of 3 + 5 = 8.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
