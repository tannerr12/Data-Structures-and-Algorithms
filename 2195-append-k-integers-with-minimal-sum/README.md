...
<pre style="position: relative;"><strong>Input:</strong> nums = [1,4,25,10,25], k = 2
...
The sum of the two integers appended is 2 + 3 = 5, so we return 5.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 2:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> nums = [5,6], k = 6
