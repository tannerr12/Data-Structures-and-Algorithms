...
<pre style="position: relative;"><strong>Input:</strong> s = "abcda", queries = [[3,3,0],[1,2,0],[0,3,1],[0,3,2],[0,4,1]]
...
<pre style="position: relative;"><strong>Input:</strong> s = "lyb", queries = [[0,1,0],[2,2,1]]
