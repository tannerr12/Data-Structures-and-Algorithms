...
<pre style="position: relative;"><strong>Input:</strong> buildings = [[1,4,2],[3,9,4]]
...
<pre style="position: relative;"><strong>Input:</strong> buildings = [[1,3,2],[2,5,3],[2,8,3]]
...
<pre style="position: relative;"><strong>Input:</strong> buildings = [[1,2,1],[5,6,1]]
