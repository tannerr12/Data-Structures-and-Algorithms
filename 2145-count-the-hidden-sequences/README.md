...
<pre style="position: relative;"><strong>Input:</strong> differences = [1,-3,4], lower = 1, upper = 6
...
<pre style="position: relative;"><strong>Input:</strong> differences = [3,-4,5,1,-2], lower = -4, upper = 5
...
<pre style="position: relative;"><strong>Input:</strong> differences = [4,-7,2], lower = 3, upper = 6
