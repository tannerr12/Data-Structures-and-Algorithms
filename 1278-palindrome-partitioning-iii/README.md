...
<strong>Explanation:</strong>&nbsp;You can split the string into "aa", "bb" and "c", all of them are palindrome.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
