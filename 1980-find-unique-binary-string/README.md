...
<pre style="position: relative;"><strong>Input:</strong> nums = ["01","10"]
...
<pre style="position: relative;"><strong>Input:</strong> nums = ["00","01"]
<strong>Output:</strong> "11"
...
<pre style="position: relative;"><strong>Input:</strong> nums = ["111","011","001"]
