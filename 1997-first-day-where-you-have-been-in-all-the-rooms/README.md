...
<pre style="position: relative;"><strong>Input:</strong> nextVisit = [0,0]
...
<pre style="position: relative;"><strong>Input:</strong> nextVisit = [0,0,2]
...
<pre style="position: relative;"><strong>Input:</strong> nextVisit = [0,1,2,0]
<strong>Output:</strong> 6
<strong>Explanation:</strong>
