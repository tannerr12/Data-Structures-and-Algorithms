...
<pre style="position: relative;"><strong>Input:</strong> s = "5525", a = 9, b = 2
...
<pre style="position: relative;"><strong>Input:</strong> s = "74", a = 5, b = 1
...
<pre style="position: relative;"><strong>Input:</strong> s = "0011", a = 4, b = 2
