...
<pre style="position: relative;"><strong>Input:</strong> buses = [10,20], passengers = [2,17,18,19], capacity = 2
...
Note that you may not arrive at the same time as another passenger, which is why you must arrive before the 1<sup>st</sup> passenger to catch the bus.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 2:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> buses = [20,30,10], passengers = [19,13,26,4,25,11,21], capacity = 2
...
Notice if you had arrived any later, then the 6<sup>th</sup> passenger would have taken your seat on the third bus.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
