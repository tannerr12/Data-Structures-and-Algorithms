...
<pre style="position: relative;"><strong>Input:</strong> times = [[1,4],[2,3],[4,6]], targetFriend = 1
...
<pre style="position: relative;"><strong>Input:</strong> times = [[3,10],[1,5],[2,6]], targetFriend = 0
