...
<pre style="position: relative;"><strong>Input:</strong> n = 6, catagoryHandler = [1,1,2,2,3,3]
...
<pre style="position: relative;"><strong>Input:</strong> n = 5, catagoryHandler = [1,2,3,4,5]
...
<pre style="position: relative;"><strong>Input:</strong> n = 3, catagoryHandler = [1,1,1]
