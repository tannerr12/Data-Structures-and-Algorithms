...
<pre style="position: relative;"><strong>Input:</strong> nums1 = [7,4], nums2 = [5,2,8,9]
...
<pre style="position: relative;"><strong>Input:</strong> nums1 = [1,1], nums2 = [1,1,1]
...
<pre style="position: relative;"><strong>Input:</strong> nums1 = [7,7,8,3], nums2 = [1,2,9,7]
