...
<pre style="position: relative;"><strong>Input:</strong> numCourses = 2, prerequisites = [[1,0]], queries = [[0,1],[1,0]]
...
<pre style="position: relative;"><strong>Input:</strong> numCourses = 2, prerequisites = [], queries = [[1,0],[0,1]]
...
<pre style="position: relative;"><strong>Input:</strong> numCourses = 3, prerequisites = [[1,2],[1,0],[2,0]], queries = [[1,0],[1,2]]
