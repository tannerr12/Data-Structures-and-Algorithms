...
<pre style="position: relative;"><strong>Input:</strong> v1 = [1,2], v2 = [3,4,5,6]
...
<pre style="position: relative;"><strong>Input:</strong> v1 = [1], v2 = []
<strong>Output:</strong> [1]
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 3:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> v1 = [], v2 = [1]
<strong>Output:</strong> [1]
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
...
<pre style="position: relative;"><strong>Input:</strong> v1 = [1,2,3], v2 = [4,5,6,7], v3 = [8,9]
