...
<pre style="position: relative;"><strong>Input:</strong> ghosts = [[1,0],[0,3]], target = [0,1]
...
<pre style="position: relative;"><strong>Input:</strong> ghosts = [[1,0]], target = [2,0]
...
<pre style="position: relative;"><strong>Input:</strong> ghosts = [[2,0]], target = [1,0]
<strong>Output:</strong> false
