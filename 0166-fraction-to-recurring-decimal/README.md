...
<pre style="position: relative;"><strong>Input:</strong> numerator = 1, denominator = 2
<strong>Output:</strong> "0.5"
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 2:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> numerator = 2, denominator = 1
<strong>Output:</strong> "2"
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 3:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> numerator = 4, denominator = 333
