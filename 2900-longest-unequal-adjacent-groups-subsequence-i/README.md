...
<pre style="position: relative;"><strong>Input:</strong> n = 3, words = ["e","a","b"], groups = [0,0,1]
...
It can be shown that the length of the longest subsequence of indices that satisfies the condition is 2.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 2:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> n = 4, words = ["a","b","c","d"], groups = [1,0,1,1]
