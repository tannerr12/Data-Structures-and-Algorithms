...
<pre style="position: relative;"><strong>Input:</strong> root = [1,3,2], k = 1
...
<pre style="position: relative;"><strong>Input:</strong> root = [1], k = 1
...
<pre style="position: relative;"><strong>Input:</strong> root = [1,2,3,4,null,null,null,5,null,6], k = 2
