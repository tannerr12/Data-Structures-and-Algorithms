...
<pre style="position: relative;"><strong>Input:</strong> head = [1,2,3,2]
...
<pre style="position: relative;"><strong>Input:</strong> head = [2,1,1,2]
...
<pre style="position: relative;"><strong>Input:</strong> head = [3,2,2,1,3,2,4]
