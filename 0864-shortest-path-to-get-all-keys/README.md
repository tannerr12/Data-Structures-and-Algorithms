...
<pre style="position: relative;"><strong>Input:</strong> grid = ["@.a..","###.#","b.A.B"]
...
<pre style="position: relative;"><strong>Input:</strong> grid = ["@..aA","..B#.","....b"]
<strong>Output:</strong> 6
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 3:</strong></p>
<img alt="" src="https://assets.leetcode.com/uploads/2021/07/23/lc-keys3.jpg" style="width: 244px; height: 85px;">
<pre style="position: relative;"><strong>Input:</strong> grid = ["@Aa"]
