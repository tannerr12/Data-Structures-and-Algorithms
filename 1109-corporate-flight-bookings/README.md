...
<pre style="position: relative;"><strong>Input:</strong> bookings = [[1,2,10],[2,3,20],[2,5,25]], n = 5
...
<pre style="position: relative;"><strong>Input:</strong> bookings = [[1,2,10],[2,2,15]], n = 2
