...
<pre style="position: relative;"><strong>Input:</strong> sweetness = [1,2,3,4,5,6,7,8,9], k = 5
...
<pre style="position: relative;"><strong>Input:</strong> sweetness = [5,6,7,8,9,1,2,3,4], k = 8
...
<pre style="position: relative;"><strong>Input:</strong> sweetness = [1,2,2,1,2,2,1,2,2], k = 2
