...
<pre style="position: relative;"><strong>Input:</strong> n = 1, k = 3
...
<pre style="position: relative;"><strong>Input:</strong> n = 1, k = 4
...
<pre style="position: relative;"><strong>Input:</strong> n = 3, k = 9
