...
<pre style="position: relative;"><strong>Input:</strong> s = "input", t = "ouput", k = 9
...
<pre style="position: relative;"><strong>Input:</strong> s = "abc", t = "bcd", k = 10
...
<pre style="position: relative;"><strong>Input:</strong> s = "aab", t = "bbb", k = 27
<strong>Output:</strong> true
