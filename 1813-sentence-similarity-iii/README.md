...
<pre style="position: relative;"><strong>Input:</strong> sentence1 = "My name is Haley", sentence2 = "My Haley"
...
<pre style="position: relative;"><strong>Input:</strong> sentence1 = "of", sentence2 = "A lot of words"
...
<pre style="position: relative;"><strong>Input:</strong> sentence1 = "Eating right now", sentence2 = "Eating"
<strong>Output:</strong> true
