...
<pre style="position: relative;"><strong>Input:</strong> heights = [2,1,1,2,1,2,2], volume = 4, k = 3
...
<pre style="position: relative;"><strong>Input:</strong> heights = [1,2,3,4], volume = 2, k = 2
...
<pre style="position: relative;"><strong>Input:</strong> heights = [3,1,3], volume = 5, k = 1
