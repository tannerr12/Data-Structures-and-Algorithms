...
<pre style="position: relative;"><strong>Input:</strong> m = 1, n = 1, r = 0, c = 0
...
<pre style="position: relative;"><strong>Input:</strong> m = 3, n = 4, r = 0, c = 0
...
(0,0)-&gt;(1,2)-&gt;(2,0)-&gt;(0,1)-&gt;(1,3)-&gt;(2,1)-&gt;(0,2)-&gt;(2,3)-&gt;(1,1)-&gt;(0,3)-&gt;(2,2)-&gt;(1,0)<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
