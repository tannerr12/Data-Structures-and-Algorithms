...
<pre style="position: relative;"><strong>Input:</strong> candies = [1,<u>2,2,3</u>,4,3], k = 3
...
<pre style="position: relative;"><strong>Input:</strong> candies = [2,2,2,<u>2,3</u>,3], k = 2
...
<pre style="position: relative;"><strong>Input:</strong> candies = [2,4,5], k = 0
<strong>Output:</strong> 3
<strong>Explanation:</strong> 
