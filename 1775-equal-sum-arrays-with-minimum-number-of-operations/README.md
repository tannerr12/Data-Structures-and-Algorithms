...
<pre style="position: relative;"><strong>Input:</strong> nums1 = [1,2,3,4,5,6], nums2 = [1,1,2,2,2,2]
...
<pre style="position: relative;"><strong>Input:</strong> nums1 = [1,1,1,1,1,1,1], nums2 = [6]
...
<pre style="position: relative;"><strong>Input:</strong> nums1 = [6,6], nums2 = [1]
<strong>Output:</strong> 3
<strong>Explanation:</strong> You can make the sums of nums1 and nums2 equal with 3 operations. All indices are 0-indexed. 
