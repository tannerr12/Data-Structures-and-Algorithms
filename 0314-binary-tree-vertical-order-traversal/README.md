...
<pre style="position: relative;"><strong>Input:</strong> root = [3,9,8,4,0,1,7]
...
<pre style="position: relative;"><strong>Input:</strong> root = [3,9,8,4,0,1,7,null,null,null,2,5]
