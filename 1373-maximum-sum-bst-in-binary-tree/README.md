...
<pre style="position: relative;"><strong>Input:</strong> root = [1,4,3,2,4,2,5,null,null,null,null,null,null,4,6]
...
<pre style="position: relative;"><strong>Input:</strong> root = [4,3,null,1,2]
...
<pre style="position: relative;"><strong>Input:</strong> root = [-4,-2,-5]
